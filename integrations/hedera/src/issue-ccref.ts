...
async function main() {
  ...
  const gasEstimate = await factory.deployEquity.estimateGas(
    equityDataArgs,
    factoryRegulationDataArgs,
  );
  ...
  console.log("");
  console.log(
    `HashScan transaction: https://hashscan.io/testnet/transaction/${tx.hash}`,
  );
  console.log("==============================================");
}
